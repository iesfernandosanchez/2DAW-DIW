...
<div id="overflowDiv">
	<div id="pngDiv"></div>
	<p><iframe src="{$clickheat_path}clickempty.html" id="webPageFrame" onload="window.setTimeout('cleanIframe();', 2000);" frameborder="0" scrolling="no" width="50" height="500"></iframe></p>
</div>
